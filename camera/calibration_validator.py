...
import cv2
import numpy as np
from typing import List, Tuple  # noqa: F401 — used by subclasses and type stubs
...
class CalibrationValidator:
    ...
    def validate_marker_pose(
        ...
        if rmse > 5.0:  # Arbitrary threshold for "poor" calibration
            log.warning(
                "High reprojection error detected: %.2f pixels. Check camera calibration!",
                rmse,
            )
